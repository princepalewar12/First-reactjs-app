...
useEffect(() => {
    console.log("Use Effect Hook call when name changed");
  },[name]);
  ...
  return (
    <>
      ...
      <h1>Count: {count}</h1>
      <Button onClick={increamentCount} variant="primary">Count ++</Button>
      <h1>Name: {name}</h1>
      <Button onClick={nameChange} variant="primary">Count ++</Button>
